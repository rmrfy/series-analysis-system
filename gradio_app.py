            ...
            with gr.Column():
                ...
                with gr.Row():
                    ...
                    with gr.Column():
                        ...
                        classify_text_button.click(classify_text, inputs=[text_classification_model, text_classification_data_path, text_to_classify], outputs=[])
